          ...
          A_StmList(
            ...
            A_StmList(
              A_Putarray(A_Pos(9,5), 
                A_NumConst(A_Pos(9,14), 8),
                A_IdExp(A_Pos(9,16), String("a"))
              ),
              A_StmList(
                ...
                A_StmList(
                  ...
                  A_StmList(
                    A_Return(A_Pos(16,5),
                      A_ArrayExp(A_Pos(16,1), A_IdExp(A_Pos(16,12), String("a")), A_NumConst(A_Pos(16,14), 1000))
                    ),
                    NULL
                  )
                )
