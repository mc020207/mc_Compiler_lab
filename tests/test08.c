        ...
        A_StmList(
          ...
          A_StmList(
            A_Return(A_Pos(5,5),
              A_CallExp(A_Pos(5,0),
                A_CallExp(A_Pos(5,0),
                  A_IdExp(A_Pos(5,12), String("x")), String("m1"), A_ExpList(
                    A_NumConst(A_Pos(5,17), 10),
                    NULL
                  )
                ), String("m2"), A_ExpList(
                  A_NumConst(A_Pos(5,24), 0),
                  NULL
                )
              )
            ),
        ...
        A_ClassDecl(A_Pos(16,1),
          ...
          A_MethodDeclList( // begin of A_MethodDeclList
            A_MethodDecl(A_Pos(18,5), // begin of MethodDecl for m2
              ...
              A_StmList(
                A_Return(A_Pos(19,9),
                  A_OpExp(A_Pos(19,33), A_ClassVarExp(A_Pos(19,16), A_CallExp(A_Pos(19,17),
                        A_ThisExp(A_Pos(19,17)), String("m1"), A_ExpList(
                          A_IdExp(A_Pos(19,25), String("x")),
                          NULL
                        )
                      ), String("c1m1")), A_plus, A_ClassVarExp(A_Pos(19,34), A_ThisExp(A_Pos(19,34)), String("i2")))
                ),
                NULL
              )
